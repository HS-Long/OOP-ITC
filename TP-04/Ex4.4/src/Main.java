...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6. Thaibaht to Dollar.");
            ...
            switch (chose){
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Input money in Thai Baht: ");
                    double thaiBahtAmount1 = input.nextDouble();
                    ThaiBaht thaiBaht1= new ThaiBaht(thaiBahtAmount1);
                    System.out.printf("%.2f Thai Baht = %.2f RIELS%n", thaiBahtAmount1, thaiBaht1.toDollar());
                    break;
                case 7:
